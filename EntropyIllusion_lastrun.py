...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\kerry\\Documents\\Kyle Files\\Park Internship\\EntropyIllusion\\EntropyIllusion_lastrun.py',
...
centralLoop = data.TrialHandler(nReps=1.0, method='fullRandom', 
