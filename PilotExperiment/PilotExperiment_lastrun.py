...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\kerry\\Documents\\Kyle Files\\PsychoPyProjects\\PilotExperiment\\PilotExperiment_lastrun.py',
...
trials = data.TrialHandler(nReps=2.0, method='random', 
    ...
    trialList=data.importConditions('PilotConditions.xlsx'),
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        # *dot_array* updates
        if dot_array.status == NOT_STARTED and tThisFlip >= soa_time-frameTolerance:
            # keep track of start time/frame for later
